...
class MetricsAggregator:
    ...
    def save_summary(self, path: str):
        ...
        print(f"\n{'='*60}")
        print("SUMMARY METRICS (IPPO - 32x32 GRID, OBS IMAGES)")
        print('='*60)
...
if __name__ == "__main__":
    ...
    output_dir = os.path.join(project_root, "artifacts", f"ippo_obs_images_eval_results/ippo_generalization_grid32_obs_images_{current_time}")
    ...
    print(f"\n{'='*60}")
    print("IPPO GENERALIZATION TEST: 32x32 GRID (OBS IMAGES)")
    print('='*60)
