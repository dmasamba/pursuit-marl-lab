...
class MetricsAggregator:
    ...
    def save_summary(self, path: str):
        ...
        print(f"\n{'='*60}")
        print("SUMMARY METRICS (MAPPO - 2 EVADERS)")
        print('='*60)
...
if __name__ == "__main__":
    # Generalization Test: Additional Evaders (2 evaders)
    # Matches: --x_size 8 --y_size 8 --max_cycles 150 --n_pursuers 2 --n_evaders 2 --n_catch 2 --freeze_evaders
    num_agents = 2
    num_evaders = 2  # KEY DIFFERENCE: 2 evaders instead of 1
    x_size = 8
    y_size = 8
    n_catch = 2
    max_cycles = 150
    ...
    output_dir = f"./results/mappo_generalization_2evaders_catch2_{current_time}"
    ...
    print(f"\n{'='*60}")
    print("MAPPO GENERALIZATION TEST: ADDITIONAL EVADERS (2)")
    print('='*60)
