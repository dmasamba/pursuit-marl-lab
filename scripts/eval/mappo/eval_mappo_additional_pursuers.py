...
class MetricsAggregator:
    ...
    def save_summary(self, path: str):
        ...
        print(f"\n{'='*60}")
        print("SUMMARY METRICS (MAPPO - 3 PURSUERS)")
        print('='*60)
...
if __name__ == "__main__":
    # Generalization Test: Additional Pursuers (3 pursuers)
    # Matches: --x_size 8 --y_size 8 --max_cycles 150 --n_pursuers 3 --n_evaders 1 --n_catch 3 --freeze_evaders
    num_agents = 3  # KEY DIFFERENCE: 3 pursuers instead of 2
    num_evaders = 1
    x_size = 8
    y_size = 8
    n_catch = 3  # KEY DIFFERENCE: All 3 pursuers must overlap evader
    max_cycles = 150
    freeze_evaders = True
    ...
    output_dir = f"./results/mappo_generalization_3pursuers_catch3_{current_time}"
    ...
    print(f"\n{'='*60}")
    print("MAPPO GENERALIZATION TEST: ADDITIONAL PURSUERS (3 pursuers)")
    print('='*60)
