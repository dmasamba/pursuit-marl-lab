...
class MetricsAggregator:
    ...
    def save_summary(self, path: str):
        ...
        print(f"\n{'='*60}")
        print("SUMMARY METRICS (MAPPO - 2 EVADERS, OBS IMAGES)")
        print('='*60)
...
if __name__ == "__main__":
    ...
    output_dir = f"./results/mappo_generalization_2evaders_obs_images_{current_time}"
    ...
    print(f"\n{'='*60}")
    print("MAPPO GENERALIZATION TEST: ADDITIONAL EVADERS (OBS IMAGES)")
    print('='*60)
