...
class MetricsAggregator:
    ...
    def save_summary(self, path: str):
        ...
        print(f"\n{'='*60}")
        print("SUMMARY METRICS (MAPPO - 32x32 GRID, OBS IMAGES)")
        print('='*60)
...
if __name__ == "__main__":
    ...
    output_dir = f"./results/mappo_generalization_grid32_obs_images_{current_time}"
    ...
    print(f"\n{'='*60}")
    print("MAPPO GENERALIZATION TEST: 32x32 GRID (OBS IMAGES)")
    print('='*60)
