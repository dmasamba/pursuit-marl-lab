...
def main():
    ...
    def pursuit_env_creator(env_config):
        env = pursuit_v4.env(
                ...
                x_size=7,  # x-dim of grid
                y_size=7,  # y-dim of grid
                n_catch=1,  # number of pursuers that can catch an evader
        ...
        # Wrap the environment with Supersuit wrappers
    ...
    analysis = tune.run(
        ...
        config=config,
        stop=stop_criteria,
        storage_path="artifacts/ippo_results",
